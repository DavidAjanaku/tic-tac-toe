...
let turnMessage;
let winingMessage;
let playerBoard = ["1a", "2a", "3a", "1b", "2b", "3b", "1c", "2c", "3c"];
let emptyFields = ["1a", "2a", "3a", "1b", "2b", "3b", "1c", "2c", "3c"];
let fieldName;
...
function doOnClick() {
  ...
  table.addEventListener("click", function (e) {
    ...
    console.log(element);
    if (element.classList.contains("td-clicked")) {
      this.preventDefault();
    }
    reset = false;
...
function chooseSign() {
  ...
  if (player1Name === "You") {
    let m = (document.querySelector(".choose-sign p").innerHTML =
      player1Name + " " + "pick first");
  } else {
    document.querySelector(".choose-sign p").innerHTML =
      player1Name + " " + "picks first";
  }
...
function playAgain() {
  ...
  const theTD = Array.from(document.querySelectorAll("#table tr td")).map(
    (td) => (td.innerHTML = " ")
  );
  ...
  oneA.classList.remove("td-clicked");
  oneB.classList.remove("td-clicked");
  oneC.classList.remove("td-clicked");
  twoA.classList.remove("td-clicked");
  twoB.classList.remove("td-clicked");
  twoC.classList.remove("td-clicked");
  threeA.classList.remove("td-clicked");
  threeB.classList.remove("td-clicked");
  threeC.classList.remove("td-clicked");

  oneA.classList.remove("td-winning-color");
  oneB.classList.remove("td-winning-color");
  oneC.classList.remove("td-winning-color");
  twoA.classList.remove("td-winning-color");
  twoB.classList.remove("td-winning-color");
  twoC.classList.remove("td-winning-color");
  threeA.classList.remove("td-winning-color");
  threeB.classList.remove("td-winning-color");
  threeC.classList.remove("td-winning-color");
  // oneA.classList.remove("td-winning-color");
  scoreInfo();
...
function checkResult(player) {
  ...
  if (
    document.getElementById("1a").innerHTML === player &&
    document.getElementById("2a").innerHTML === player &&
    document.getElementById("3a").innerHTML === player
  ) {
    ...
    document.getElementById("1b").innerHTML === player &&
    document.getElementById("2b").innerHTML === player &&
    document.getElementById("3b").innerHTML === player
  ) {
    ...
    document.getElementById("1c").innerHTML === player &&
    document.getElementById("2c").innerHTML === player &&
    document.getElementById("3c").innerHTML === player
  ) {
...
function scoreInfo() {
  document.querySelector(".scores p").innerHTML =
    player1Score + " : " + player2Score;
  document.querySelector(".player2-score").innerHTML =
    player2Name + "'s score: " + player2Score;
  document.querySelector(".player1-score").innerHTML =
    player1Name + "'s score: " + player1Score;

  if (player1Name === "You") {
    document.querySelector(".player1-score").innerHTML =
      player1Name + "r score: " + player1Score;
  }
